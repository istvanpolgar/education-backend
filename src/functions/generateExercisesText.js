...
const convertString = (text) => {
    ...
    for(var i in conversions){
        ...
        _text = _text.replace(re,i);
    } 
    _text = _text.replace(/[^a-z0-9]/g, ""); 
    return _text;
}

const generateExercisesText = (exercises, category, exercise) => {
    let ex_index = 0;
    ...
    const {question, answer} = modules[category](ex_index + 1);
